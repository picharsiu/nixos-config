...
stdenv.mkDerivation (finalAttrs: {
  ...
  postInstall = ''
    install -vD manifest.json "$out/gmp-widevinecdm/system-installed/manifest.json"
    install -vD libwidevinecdm.so "$out/gmp-widevinecdm/system-installed/libwidevinecdm.so"
  '';
